...
import 'package:nonghang/tool/webserve/LCWebConfig.dart';
import 'package:nonghang/tool/webserve/LCWebInterceptors.dart';
import 'package:nonghang/tool/webserve/LCWebResultData.dart';
  ...
  LCWebRequstManager._internal({String baseUrl}) {
    if (null == _client) {
      _client = Dio(BaseOptions(
        ...
        contentType: ContentType.json, //请求的Content-Type，默认值是[ContentType.json]
