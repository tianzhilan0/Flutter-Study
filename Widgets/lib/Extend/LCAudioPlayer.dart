...
class LCAudioPlayer extends StatefulWidget {
  LCAudioPlayer({Key key}) : super(key: key);

  @override
  _LCAudioPlayerState createState() => _LCAudioPlayerState();
}

class _LCAudioPlayerState extends State<LCAudioPlayer> {
