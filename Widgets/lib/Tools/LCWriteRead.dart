...
class LCWriteRead extends StatefulWidget {
  LCWriteRead({Key key}) : super(key: key);

  @override
  _LCWriteReadState createState() => _LCWriteReadState();
}

class _LCWriteReadState extends State<LCWriteRead> {
